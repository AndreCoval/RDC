...
function Contactform() {
    ...
    return (
        <div className='text-white font-notoSans flex flex-col pt-5 -mb-14 sm:-mb-24 md:pt-16'>
        ...
        <img className=' left-0 bottom-0 opacity-5 w-full h-[500px] md:h-[800px] md:w-[80%] absolute z-10' src={pic1} alt="/" />
            ...
            <form className='w-full xl:w-[65%] md:mr-8 md:ml-auto sm:pl-8 grid md:grid-cols-2 gap-16' action="/" method="post"  onSubmit={handleSubmit}>
            ...
            <div className='mx-14 sm:m-0  flex flex-col'>
                ...
                <input className='z-20 text-light text-[#809FC6] mt-4 bg-transparent border-b-2 border-[#809FC6]' type="text" name="name" id="name" placeholder='' value={formValue.name} onChange={handleInput}/>
            </div>
            <div className='mx-14 sm:m-0  flex flex-col'>
                <label className=' text-start text-2xl ty-8 uppercase text-medium' htmlFor="">empresa</label>
                <input className='z-20 text-light text-[#809FC6] mt-4 bg-transparent border-b-2 border-[#809FC6]' type="text" name="name" id="name" placeholder='' value={formValue.company} onChange={handleInput}/>
            </div>
            <div className='mx-14 sm:m-0  flex flex-col'>
                <label className=' text-start text-2xl ty-8 uppercase text-medium' htmlFor="">email</label>
                <input className='z-20 text-light text-[#809FC6] mt-4 bg-transparent border-b-2 border-[#809FC6]' type="text" name="name" id="name" placeholder='' value={formValue.email} onChange={handleInput}/>
            </div>
            <div className='mx-14 sm:m-0  flex flex-col'>
                <label className=' text-start text-2xl ty-8 uppercase text-medium' htmlFor="">telemóvel</label>
                <input className='z-20 text-light text-[#809FC6] mt-4 bg-transparent border-b-2 border-[#809FC6]' type="text" name="name" id="name" placeholder='' value={formValue.phone} onChange={handleInput}/>
            </div>
            <div className='mx-14 sm:m-0 flex flex-col sm:col-span-2 sm:max-w-3xl'>
                ...
                <textarea className='z-20 text-light mt-4' name="mensagem" id="mensagem" variant="standard" cols="1" rows="3" value={formValue.message} onChange={handleInput}></textarea>
            </div>
            <button type='submit' className='z-20 bg-[#115CC9] mx-auto sm:mx-0 w-60 md:w-96 text-xl md:text-3xl font-notoSans font-bold mb-24 py-1 text-white hover:animate-pulse animate-once animate-ease-in'>submeter</button>
