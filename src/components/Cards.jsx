...
const Cards = () => {
  return (
    <div className='w-full sm:max-w-[1500px] mx-auto my-8 text-white font-notoSans'>
        <div className='w-full mx-auto sm:px-16 px-6 py-8 mb-34 gap-4 grid lg:grid-cols-2'>
            <div className='w-full h-full grid gap-4'>
                <Link to="/services">
                    <div className='group w-full h-[300px] relative'>
                ...
                <div className='w-full h-full lg:h-[400px] gap-4 grid md:grid-cols-2'>
            ...
            <Link to="/services">
                <div className='group relative grid w-full h-[300px] md:h-full'>
                <img className='h-full w-full object-cover object-center' src={Cortelaser} alt="/" />
